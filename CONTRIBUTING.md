# Contributing to qualcomm-CDI-generator
...
1. [Fork](https://github.com/qualcomm-linux/qualcomm-CDI-generator/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/qualcomm-CDI-generator.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/qualcomm-CDI-generator.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/qualcomm-CDI-generator/pulls) from your branch to `main`.
